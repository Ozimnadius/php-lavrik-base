...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 13 2020 г., 01:04
...
INSERT INTO `articles` (`id_article`, `id_user`, `id_cat`, `title`, `content`, `dt_add`, `status`)
VALUES (1, 1, 1, 'Загрузка картинки', 'уцкуцкуцк', '2020-02-12 17:43:22', 1),
...
INSERT INTO `cats` (`id_cat`, `title`, `url`)
VALUES (1, 'Основы PHP', 'osnovy-php'),
...
VALUES (1, 'Загрузка файла на сервер', 'file-upload'),
...
INSERT INTO `users` (`id_user`, `login`, `password`, `name`)
VALUES (1, 'admin', 'ewrewrewrrt436t43y34y', 'Admin'),
