...
INSERT INTO `departaments` (`id_dep`, `title`, `phone`, `email`, `address`)
VALUES (1, 'IT', '11111111', '1@1', 'ул.Нз, д.404');
...
INSERT INTO `products` (`id_products`, `id_cat`, `title`, `description`, `dt_add`, `sale`)
VALUES (1, 1, 'Inpone X', '1', '2020-02-05 12:36:37', 0),
...
INSERT INTO `shops` (`id_shop`, `title`, `site`, `address`)
VALUES (1, 'Mvideo', 'mvideo', 'qwewqe'),
...
INSERT INTO `shops_products` (`id_shop`, `id_product`, `cost`, `rest`)
VALUES (1, 1, 1000, 0),
       (1, 2, 2000, 0),
       (4, 1, 3000, 0),
       (4, 2, 3000, 0);
...
ALTER TABLE `shops_products`
  ...
  ADD CONSTRAINT `shops_products_ibfk_2` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_products`) ON
DELETE
