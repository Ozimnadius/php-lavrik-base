...
INSERT INTO `articles` (`id_article`, `id_category`, `title`, `slug`, `content`, `created_at`)
VALUES (1, 1, 'Основы PHP для начинающих', 'osnovy-php-dlya-nachinayushchih',
        ...
        '2026-03-10 13:44:25'),
       (2, 2, 'Как работать с MySQL в PHP', 'kak-rabotat-s-mysql-v-php',
        ...
        '2026-03-10 13:44:25'),
       (3, 3, 'Что такое адаптивная вёрстка', 'chto-takoe-adaptivnaya-verstka',
        ...
        '2026-03-10 13:44:25'),
       (4, 4, 'Роутинг и структура backend-приложения', 'routing-i-struktura-backend-prilozheniya',
        ...
        '2026-03-10 13:44:25'),
       (5, 1, 'Переменные и типы данных в PHP', 'peremennye-i-tipy-dannyh-v-php',
        'В этой статье рассмотрены основные типы данных в PHP, работа с переменными, строками, числами и логическими значениями.',
        '2026-03-10 13:48:20'),
       (6, 1, 'Условные операторы и циклы в PHP', 'uslovnye-operatory-i-cikly-v-php',
        'Разбираем конструкции if, else, elseif, switch, а также циклы for, while и foreach на простых примерах.',
        '2026-03-10 13:48:20'),
       (9, 3, 'Основы HTML для создания страниц', 'osnovy-html-dlya-sozdaniya-stranic',
        'Краткое введение в HTML: структура документа, заголовки, абзацы, ссылки, изображения и списки.',
        '2026-03-10 13:48:20'),
       (10, 3, 'Что такое CSS и как подключить стили', 'chto-takoe-css-i-kak-podklyuchit-stili',
        'Рассматриваем способы подключения CSS, базовые свойства оформления и работу с классами и селекторами.',
        '2026-03-10 13:48:20'),
       (11, 4, 'Что делает backend-разработчик', 'chto-delaet-backend-razrabotchik',
        'Разбираем задачи backend-разработки: обработка запросов, работа с базой данных, бизнес-логика и безопасность.',
        '2026-03-10 13:48:20'),
       (12, 4, 'Как устроено взаимодействие клиента и сервера', 'kak-ustroeno-vzaimodejstvie-klienta-i-servera',
        'В статье объясняется, как браузер отправляет запросы на сервер, как сервер их обрабатывает и возвращает ответ.',
        '2026-03-10 13:48:20'),
...
INSERT INTO `categories` (`id_category`, `name`, `slug`, `created_at`)
VALUES (1, 'PHP', 'php', '2026-03-10 13:44:25'),
