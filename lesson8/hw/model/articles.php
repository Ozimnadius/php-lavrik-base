...
{
  $sql = "INSERT INTO articles (id_category, title, content, id_user) VALUES (:id_category, :title, :content, :id_user);";
  dbQuery($sql, $fields);
...
function articleFields(array $source = []): array
{
  return [
    'title' => trim((string)($source['title'] ?? '')),
    'id_category' => trim((string)($source['id_category'] ?? '')),
